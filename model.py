...
class model:
    def __init__(self):
        ...
        self.db_connection = self.db_connection.conectar() #Conecto ao bancop de dados
        self.con = self.db_connection.cursor()#Navega no meu bancon 
    ...
    def consultar(self,codigo):
        try:
            ...
            for(codigo,nome,telefone,endereco,dataDeNascimento) in self.con:
                msg = msg + "\nCodigo: {}, Nome: {},Telefone:{},Endereco {},Nascimento{}".format(codigo,nome,telefone,endereco,self.tratarData(dataDeNascimento))
                return msg 
        except Exception as erro:
                return erro
